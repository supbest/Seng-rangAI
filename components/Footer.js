...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-50 w-full pt-20 pb-10 border-t border-slate-200">
      <div className="max-w-[1440px] mx-auto px-margin-desktop grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="col-span-1">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="font-headline-lg text-xl font-bold text-slate-900">Storefront AI</span>
          </div>
          ...
          <div className="flex gap-3">
            <Link className="w-10 h-10 rounded-full bg-white flex items-center justify-center text-slate-400 hover:text-primary shadow-sm transition-colors border border-slate-100" href="/">
        ...
        <div className="space-y-4">
          <h4 className="font-bold text-slate-900">Menu</h4>
        ...
        <div className="space-y-4">
          <h4 className="font-bold text-slate-900">Help</h4>
          <ul className="space-y-2 text-slate-500">
      ...
      <div className="border-t border-slate-200 pt-8 px-margin-desktop text-center">
        <p className="text-sm text-slate-400">© {currentYear} Storefront AI. Smart Solutions for Smart Businesses.</p>
      </div>
    </footer>
  );
}
